...
const silderWrap2 = document.querySelector(".smallslider");
...
prevBtn2.addEventListener("click",(e)=>{
    ...
    silderStartw(); //슬라이드 화면 전환 및 동그라미 버튼 활성비활성 함수 호출
...
let autoSiled2 = setInterval(()=>{
    ...
    silderStartw(); // 슬라이드 화면 전환되고 동그라미 버튼 활성 비활성
...
silderWrap2.addEventListener("mouseleave",()=>{
    //autosile2 변수에 자동실행 함수를 다시 새롬게 대입해서 채워줌
...
function silderStartw(){
    ...
    silderView2[sNumber2].style.zIndex = 3;
        ...
        // silder 는 버튼 이랑 동그라미 까지 다 포함되어 있음
        const silderWrap22 = document.querySelector(".smallslider2");
